...
sudo sed -i "s|listen = 127.0.0.1:9000|listen = 127.0.0.1:9005|" $php_fpm && \
...
sudo sed -i "s|user = apache|user = vagrant|" $php_fpm && \
sudo sed -i "s|group = apache|group = vagrant|" $php_fpm && \
sudo sed -i "s|listen = 127.0.0.1:9000|listen = 127.0.0.1:9006|" $php_fpm && \
sudo sed -i "s|;listen.owner = nobody|listen.owner = vagrant|" $php_fpm && \
sudo sed -i "s|;listen.group = nobody|listen.group = vagrant|" $php_fpm
...
php70_php_fpm="/opt/remi/php70/root/etc/php-fpm.d/www.conf"
sudo sed -i "s|user = apache|user = vagrant|" $php_fpm && \
sudo sed -i "s|group = apache|group = vagrant|" $php_fpm && \
sudo sed -i "s|listen = 127.0.0.1:9000|listen = 127.0.0.1:9007|" $php_fpm && \
sudo sed -i "s|;listen.owner = nobody|listen.owner = vagrant|" $php_fpm && \
sudo sed -i "s|;listen.group = nobody|listen.group = vagrant|" $php_fpm
...
php71_php_fpm="/opt/remi/php71/root/etc/php-fpm.d/www.conf"
sudo sed -i "s|user = apache|user = vagrant|" $php_fpm && \
sudo sed -i "s|group = apache|group = vagrant|" $php_fpm && \
sudo sed -i "s|listen = 127.0.0.1:9000|listen = 127.0.0.1:9008|" $php_fpm && \
sudo sed -i "s|;listen.owner = nobody|listen.owner = vagrant|" $php_fpm && \
sudo sed -i "s|;listen.group = nobody|listen.group = vagrant|" $php_fpm
sudo systemctl start php71-php-fpm
sudo systemctl enable php71-php-fpm

# Setup PHP 7.2 for Nginx
sudo yum -y install php72-php-bcmath php72-php-cli php72-php-common php72-php-fpm php72-php-gd php72-php-intl php72-php-mbstring php72-php-mcrypt php72-php-mysqlnd php72-php-opcache php72-php-pdo php72-php-pear php72-php-pecl-uploadprogress php72-php-soap php72-php-xml php72-php-xmlrpc php72-php-pecl-memcache php72-php-pecl-memcached php72-php-pgsql php72-php-pecl-mongodb php72-php-pecl-redis
php72_php_fpm="/opt/remi/php72/root/etc/php-fpm.d/www.conf"
sudo sed -i "s|user = apache|user = vagrant|" $php_fpm && \
sudo sed -i "s|group = apache|group = vagrant|" $php_fpm && \
sudo sed -i "s|listen = 127.0.0.1:9000|listen = 127.0.0.1:9009|" $php_fpm && \
sudo sed -i "s|;listen.owner = nobody|listen.owner = vagrant|" $php_fpm && \
sudo sed -i "s|;listen.group = nobody|listen.group = vagrant|" $php_fpm
